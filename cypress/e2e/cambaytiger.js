...
//         cy.wait(10000);
//         cy.get('#header > div.scss_mainNavContainerWrapper__m_O_A > div > div.scss_logoSearchContainer__ca6MR > div:nth-child(3) > div.scss_GGLocation__cfABD > div > div:nth-child(6) > div.GGLocation__input > input', { timeout: 100000 })
...
//                     //   cy.contains('COD').then(($radio) => {
//                     //     if (!$radio.is(':checked')) {
//                     //       // If not selected, click and call the function recursively
//                     //       cy.wrap($radio).click();
//                     //       selectRadioButton(); // Call the function again to check and click if necessary
//                     //     }
//                     //   });
//                     // }
...
//                     // // Call the function
//                     // selectRadioButton();                      
//                     // cy.contains('COD', { timeout: 100000 }).click({ force: true });
//                     // cy.wait(3000);
//                     // cy.contains('COD', { timeout: 100000 }).click({ force: true });
//                     // cy.wait(10000);
...
// //                     let attempt = 0; // To prevent an infinite loop if needed

// // cy.url().then((initialUrl) => {
// //   cy.get('.payment_button__text__busIX',{timeout:100000}).click({ force: true });

// //   // Continuously check until the URL changes
// //   cy.wrap(null).should(() => {
// //     cy.url().then((currentUrl) => {
// //       if (currentUrl === initialUrl && attempt < 10) {  // Set a limit for attempts to avoid infinite looping
// //         cy.get('.payment_button__text__busIX').click();
// //         attempt++;
// //         throw new Error('URL has not changed yet'); // Throw error to retry
// //       }
// //     });
// //   });
// // });
